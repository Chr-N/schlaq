...
export default ({ title, user, workspaceScope, workspaces, scope, scopeStarred, starred, channels, dms, messages, primusLib, dbHostAddress }) => (
  <Layout title={title} primusLib={primusLib} dbHostAddress={dbHostAddress} >
    <div css={styles}>
      <Header />
      <Sidebar
        scope={scope}
